...
- [Чек-лист по требованиям](https://docs.google.com/spreadsheets/d/1RrPbqZA47ZTR-DjoEVJ-xvVK8xZq3R3ibYBpJ8fSXuM/edit?gid=899462569#gid=899462569) — проверка взаимодействия с устройством и общие проверки для мобильных приложений.
- [Чек-лист регрессионный](https://docs.google.com/spreadsheets/d/1RrPbqZA47ZTR-DjoEVJ-xvVK8xZq3R3ibYBpJ8fSXuM/edit?gid=1540435533#gid=1540435533) — проверка измененной функциональности.

### Баг-репорты
- Все баги были задокументированы в [Google Sheets](https://docs.google.com/spreadsheets/d/1RrPbqZA47ZTR-DjoEVJ-xvVK8xZq3R3ibYBpJ8fSXuM/edit?gid=1720733563#gid=1720733563).
...
## Выводы и достижения
Все требования, затронутые изменениями, были покрыты чек-листом. Из 51 проверки успешно прошло 40 тестов, 11 тестов не прошло. С учётом того, что блокирующих и критических  багов не найдено, команда тестирования не против публикации новой версии приложения в Google Play.
